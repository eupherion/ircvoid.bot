...
outputVerbose = true           # RAW вывод на консоль (актуально только для работы в foreground)
outputDebug = false            # Флаг отладочного режима (актуально только для работы в foreground)
